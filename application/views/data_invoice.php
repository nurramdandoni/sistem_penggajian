                  ...
                  <?php foreach($karyawan->result() as $kry){ ?>
                    <tr>
                      ...
                      <td style="text-align:center;">
                        <a data-toggle="tooltip" target="_blank" title="Lihat" type="button" class="btn btn-success" href="<?php echo base_url()?>admin/lihatInvoiceGaji/<?php echo $kry->NIK; ?>" role="button"><i class="ion ion-eye"></i></a>
